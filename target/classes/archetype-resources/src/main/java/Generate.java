...
public class Generate {
    ...
    private final static String AUTHOR = "sys";
    private final static String BASE_PACKAGE = "${package}";
    ...
    private static DataSourceConfig loadDataSourceConfig() {
        ...
        try {
            ...
            prop.load(inStream);
            dsc.setUrl(prop.getProperty("url"));
            dsc.setDriverName(prop.getProperty("driver-class-name"));
